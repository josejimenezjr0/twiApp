...
// @Component({
//   selector: 'app-naalu',
//   templateUrl: './naalu.component.html',
//   styleUrls: ['./naalu.component.scss']
// })
// export class NaaluComponent implements OnInit {
...
//   ngOnInit() {
//     this._httpService.getNaaluApi().subscribe((data) => {
//       this.faction = data;
