...
// @Component({
//   selector: 'app-hacan',
//   templateUrl: './hacan.component.html',
//   styleUrls: ['./hacan.component.scss']
// })
// export class HacanComponent implements OnInit {
...
//   ngOnInit() {
//     this._httpService.getHacanApi().subscribe((data) => {
//       this.faction = data;
//       console.log('Hacan Data')
