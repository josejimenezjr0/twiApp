...
// @Component({
//   selector: 'app-sardakk',
//   templateUrl: './sardakk.component.html',
//   styleUrls: ['./sardakk.component.scss']
// })
// export class SardakkComponent implements OnInit {
...
//   ngOnInit() {
//     this._httpService.getSardakkApi().subscribe((data) => {
//       this.faction = data;
